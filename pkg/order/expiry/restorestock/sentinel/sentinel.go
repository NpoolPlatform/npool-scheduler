...
func (h *handler) feedOrder(ctx context.Context, order *ordermwpb.Order, exec chan interface{}) error {
	if order.OrderState == ordertypes.OrderState_OrderStateRestoreExpiredStock {
		state := ordertypes.OrderState_OrderStateRestoreExpiredStockCheck
...
func (h *handler) InitScan(ctx context.Context, exec chan interface{}) error {
	return h.scanOrders(ctx, ordertypes.OrderState_OrderStateRestoreExpiredStockCheck, exec)
}
