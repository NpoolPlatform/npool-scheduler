...
func (h *handler) feedOrder(ctx context.Context, order *ordermwpb.Order, exec chan interface{}) error {
	if order.OrderState == ordertypes.OrderState_OrderStatePaymentBalanceSpent {
		newState := ordertypes.OrderState_OrderStatePaymentBalanceSpentCheck
...
func (h *handler) Scan(ctx context.Context, exec chan interface{}) error {
	if err := h.scanOrderPayment(ctx, ordertypes.OrderState_OrderStatePaymentBalanceSpentCheck, exec); err != nil {
		return err
	}
	return h.scanOrderPayment(ctx, ordertypes.OrderState_OrderStatePaymentBalanceSpent, exec)
}

func (h *handler) InitScan(ctx context.Context, exec chan interface{}) error {
	return h.scanOrderPayment(ctx, ordertypes.OrderState_OrderStatePaymentBalanceSpentCheck, exec)
}
