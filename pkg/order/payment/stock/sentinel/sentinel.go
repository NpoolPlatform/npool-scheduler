...
func (h *handler) Scan(ctx context.Context, exec chan interface{}) error {
	if err := h.scanOrderPayment(ctx, ordertypes.OrderState_OrderStateGoodStockTransferredCheck, exec); err != nil {
		return err
	}
	return h.scanOrderPayment(ctx, ordertypes.OrderState_OrderStateGoodStockTransferred, exec)
}

func (h *handler) InitScan(ctx context.Context, exec chan interface{}) error {
	return h.scanOrderPayment(ctx, ordertypes.OrderState_OrderStateGoodStockTransferredCheck, exec)
}
