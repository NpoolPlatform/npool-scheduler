...
func (h *handler) Scan(ctx context.Context, exec chan interface{}) error {
	if err := h.scanOrderPayment(ctx, ordertypes.OrderState_OrderStateCommissionAddedCheck, exec); err != nil {
		return err
	}
	return h.scanOrderPayment(ctx, ordertypes.OrderState_OrderStateCommissionAdded, exec)
}

func (h *handler) InitScan(ctx context.Context, exec chan interface{}) error {
	return h.scanOrderPayment(ctx, ordertypes.OrderState_OrderStateCommissionAddedCheck, exec)
}
