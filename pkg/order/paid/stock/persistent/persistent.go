...
import (
	...
	types "github.com/NpoolPlatform/npool-scheduler/pkg/order/paid/stock/types"
...
func (p *handler) withUpdateOrderState(dispose *dtmcli.SagaDispose, order *types.PersistentOrder) {
	state := ordertypes.OrderState_OrderStateUpdateInServiceChilds
	rollback := true
...
func (p *handler) Update(ctx context.Context, order interface{}, notif, done chan interface{}) error {
	...
	if _order.CreateMethod != ordertypes.OrderCreateMethod_OrderCreatedByRenew {
