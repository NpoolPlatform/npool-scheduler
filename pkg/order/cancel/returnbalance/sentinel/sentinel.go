...
func (h *handler) feedOrder(ctx context.Context, order *ordermwpb.Order, exec chan interface{}) error {
	if order.OrderState == ordertypes.OrderState_OrderStateReturnCanceledBalance {
		state := ordertypes.OrderState_OrderStateReturnCanceledBalanceCheck
...
func (h *handler) Scan(ctx context.Context, exec chan interface{}) error {
	if err := h.scanOrders(ctx, ordertypes.OrderState_OrderStateReturnCanceledBalanceCheck, exec); err != nil {
		return err
	}
	return h.scanOrders(ctx, ordertypes.OrderState_OrderStateReturnCanceledBalance, exec)
}

func (h *handler) InitScan(ctx context.Context, exec chan interface{}) error {
	return h.scanOrders(ctx, ordertypes.OrderState_OrderStateReturnCanceledBalanceCheck, exec)
}
