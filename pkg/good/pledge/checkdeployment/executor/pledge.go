...
func (h *pledgeHandler) checkContractState() error {
	// TODO use proxy check contract state
	h.Pledge.ContractState = goodtypes.ContractState_ContractDeploymentSuccess
	return nil
}
...
func (h *pledgeHandler) exec(ctx context.Context) error {
	...
	if err := h.checkContractState(); err != nil {
		return err
	}
	return nil
}
