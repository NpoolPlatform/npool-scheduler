...
func (h *handler) scanPledges(ctx context.Context, state goodbasepb.GoodState, goodType goodbasepb.GoodType, contractState goodbasepb.ContractState, exec chan interface{}) error {
	offset := int32(0)
...
func (h *handler) Scan(ctx context.Context, exec chan interface{}) error {
	return h.scanPledges(ctx,
		...
		goodbasepb.ContractState_ContractWaitDeployment,
		exec)
}
