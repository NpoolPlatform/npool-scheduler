...
require (
	...
	github.com/NpoolPlatform/cloud-hashing-order v0.0.0-20220724073727-3521f8cc05c7
	github.com/NpoolPlatform/go-service-framework v0.0.0-20220723135257-710ae88c12af
