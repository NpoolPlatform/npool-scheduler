...
require (
	...
	github.com/NpoolPlatform/inspire-middleware v0.0.0-20230227070648-d731a5173435
	...
	github.com/NpoolPlatform/order-middleware v0.0.0-20230227072249-c70f1f2a04b3
